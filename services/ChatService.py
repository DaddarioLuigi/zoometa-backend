...
“La conversazione è stata chiusa per linguaggio inappropriato. Per ulteriori necessità, contatta l’assistenza clienti
    ...
    def handle_audio_query(self, audio_file, response_format="html"):
        ...
        return self.handle_user_query_with_audio(user_text, response_format)

    def handle_user_query_with_audio(self, user_query, response_format="html"):
        """Process a text query and also return the spoken response."""
        raw_response = self.handle_user_query(user_query, "text")
